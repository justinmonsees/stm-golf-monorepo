...
const AddAttendeesForm = ({ addAttendeeToList, regGroupID }) => {
  const { attendeeItems, currentEvent } = useAttendeeContext();
  ...
  const onSubmit = async (data) => {
    ...
    const newAttendeeData = {
      ...
      registration_group_id: regGroupID,
    };
    addAttendeeToList(newAttendeeData);
    resetForm();
  };
...
export default AddAttendeesForm;
