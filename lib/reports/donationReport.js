...
const reformatDonationDataByCat = (donations) => {
  ...
  Object.values(donationByCat).forEach((donationObj) =>
    donationObj.donations.sort((donation1, donation2) => {
      const companyName1 = donation1.sponsor.company_name.toUpperCase();
      const companyName2 = donation2.sponsor.company_name.toUpperCase();
